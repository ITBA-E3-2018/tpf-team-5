...
module ImageDrawer(
  ...
  image
    ...
    parameter IMAGE_WIDTH = (9.75*SCREEN_WIDTH); //Ancho realmente utilizado para dibujar.
    ...
    output reg [((IMAGE_WIDTH*IMAGE_HEIGHT)-1):0] image; //Se guarda la imagen de la pantalla.
      ...
      begin
        ...
        for (j=0;j<(DIGIT_WIDTH/10) ; j=j+1) begin
          for (i = 0; i<(DIGIT_HEIGHT) ; i=i+1) begin
            ...
            image[pos_i+(i+0.9)*IMAGE_WIDTH+j]=ON;
          end
        end
